...
if grep -q "${INGRESS_IP}" /etc/hosts ; then
  ...
  echo "--------------------------------"
  echo "192.168.99.104 alertmanager.ofc"
  echo "192.168.99.104 grafana.ofc"
  echo "192.168.99.104 prometheus.ofc"
  echo "192.168.99.104 simpleservice.ofc"
  echo "--------------------------------"
  echo "then you're good to go"
  echo "to http://simpleservice.ofc/"
  echo "or http://grafana.ofc/ user: admin pw: prom-operator"
fi
